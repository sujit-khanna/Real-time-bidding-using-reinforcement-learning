...
if __name__ == "__main__":
    ...
    model_type =f"budget 1.5x DeepModel multiple lbk unique budget tanh action -a2c_l_r: {LEARNING_RATE}, en_b :{ENTROPY_BETA}, " \
    ...
    writer = SummaryWriter(comment=f"budget 1.5x DeepModel multiple lbk unique budget tanh action -a2c_l_r: {LEARNING_RATE}, en_b :{ENTROPY_BETA}, max_ep:"
