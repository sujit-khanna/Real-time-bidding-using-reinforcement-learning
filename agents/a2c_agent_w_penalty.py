from env import rtb_environment_w_penalty as rtb_env
import pandas as pd
import numpy as np0
...
if __name__ == "__main__":
    ...
    model_type =f"DeepModel multiple lbk w penalty unique budget tanh action -a2c_l_r: {LEARNING_RATE}, en_b :{ENTROPY_BETA}, " \
    ...
    writer = SummaryWriter(comment=f"DeepModel multiple lbk w penalty unique budget tanh action -a2c_l_r: {LEARNING_RATE}, en_b :{ENTROPY_BETA}, max_ep:"
