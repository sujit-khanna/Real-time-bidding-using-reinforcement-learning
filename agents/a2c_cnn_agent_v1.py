...
if __name__ == "__main__":
    ...
    model_type = f" 0.75x Budget CNN model unique budget tanh action -a2c_l_r: {LEARNING_RATE}, en_b :{ENTROPY_BETA}, " \
    ...
    writer = SummaryWriter(comment=f" 0.75x Budget CNN model unique budget tanh action -a2c_l_r: {LEARNING_RATE}, en_b :{ENTROPY_BETA}, max_ep:"
